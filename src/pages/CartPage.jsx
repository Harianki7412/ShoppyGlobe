          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 text-right">
            ...
            <div className="flex justify-end space-x-4">
              <button
                ...
                className="bg-red-600 text-white px-6 py-3 rounded-md hover:bg-red-700 transition-colors font-semibold shadow-md"
              >
                Clear Cart
              </button>
              <button
                onClick={handleCheckout}
                className="bg-green-600 text-white px-6 py-3 rounded-md hover:bg-green-700 transition-colors font-semibold shadow-md"
              >
                Proceed to Checkout
              </button>
            </div>
