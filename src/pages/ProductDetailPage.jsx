...
function ProductDetailPage() {
  ...
  return (
    <div className="py-8 max-w-6xl mx-auto bg-white rounded-lg shadow-xl p-8 lg:flex lg:space-x-8">
      ...
      <div className="lg:w-1/2 text-left">
        ...
        <p className="text-gray-600 text-xl mb-4">{product.brand} - {product.category}</p>

        <div className="flex items-center mb-4">
          <span className="text-yellow-500 text-2xl font-semibold flex items-center mr-4">
            {product.rating}
          ...
          <span className="text-gray-500 text-lg">({product.stock} in stock)</span>
        </div>

        <p className="text-gray-900 font-bold text-5xl mb-6">${product.price.toFixed(2)}</p>

        <button
          onClick={handleAddToCart}
          className="bg-green-600 text-white px-8 py-4 rounded-lg text-xl font-semibold hover:bg-green-700 transition-colors duration-300 shadow-md mr-4"
        >
          Add to Cart
        </button>
        <button
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <h3 className="text-2xl font-semibold text-gray-800 mb-3">Product Description</h3>
