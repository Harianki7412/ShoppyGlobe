  ...
  return (
    <div className="bg-white rounded-lg shadow-lg overflow-hidden flex flex-col h-full transform transition-transform hover:scale-105">
      ...
      <div className="p-5 flex flex-col flex-grow">
        <Link to={`/products/${product.id}`} className="text-gray-900 font-semibold text-xl mb-2 hover:text-blue-600 transition-colors line-clamp-2">
          {product.title}
        </Link>
        ...
        <button
          ...
          className="w-full bg-blue-600 text-white py-3 px-6 rounded-md font-semibold hover:bg-blue-700 transition-colors duration-200 shadow-md"
        >
          Add to Cart
        </button>
      </div>
